        ...
        <div class="p-6">
            <form action="{{ route('admin.roles.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Name -->
                    <div>
                        <label for="name" class="block text-sm font-medium text-gray-700">Role Name (System Name)</label>
                        ...
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">This will be used in code. Use lowercase, no spaces.</p>
                    </div>
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-1 flex items-center space-x-3">
                        ...
                        <div id="color-preview" class="w-10 h-10 rounded border-2 border-gray-300" style="background-color: {{ old('color', '#3B82F6') }};"></div>
                    </div>
