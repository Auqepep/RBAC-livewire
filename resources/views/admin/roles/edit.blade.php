            ...
            <form method="POST" action="{{ route('admin.groups.roles.update', [$group, $role]) }}">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $role->name) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" placeholder="e.g., manager, staff" required>
                        @error('name')
