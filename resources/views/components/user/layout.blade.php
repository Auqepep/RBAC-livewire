        ...
        <nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="shrink-0 flex items-center">
                            <a href="{{ route('dashboard') }}" class="text-lg sm:text-xl font-semibold text-gray-800">
                                {{ config('app.name') }}
                            </a>
                        </div>
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        ...
                        @auth
                            @if(Auth::user()->canManageSystem())
                                <a href="{{ route('admin.dashboard') }}" class="ml-4 text-gray-500 hover:text-gray-700 text-sm">
                                    Admin
                                </a>
                            @endif
                        @endauth
            ...
            <div :class="{'block': open, 'hidden': !open}" class="hidden sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <a href="{{ route('users.index') }}" class="block pl-3 pr-4 py-2 border-l-4 {{ request()->routeIs('users.*') ? 'border-blue-500 text-blue-700 bg-blue-50' : 'border-transparent text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300' }} text-base font-medium transition duration-150 ease-in-out">
                        Users
                    </a>
