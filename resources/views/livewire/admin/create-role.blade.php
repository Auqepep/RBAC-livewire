    ...
    <form wire:submit="save" class="space-y-6">
        ...
        <div>
            ...
            <input 
                type="number" 
                id="hierarchy_level"
                wire:model.blur="hierarchy_level"
                min="1"
                max="10"
                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                placeholder="1"
            >
            <p class="mt-1 text-xs text-gray-500">Higher numbers indicate more senior roles (1 = Member, 6 = Super Admin)</p>
