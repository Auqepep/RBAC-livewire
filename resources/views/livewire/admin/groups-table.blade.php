                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex justify-end space-x-2">
                                    ...
                                    <button 
                                        ...
                                        wire:confirm="Are you sure you want to {{ $group->is_active ? 'deactivate' : 'activate' }} this group?"
                                    >
                                    ...
                                    <button 
                                        ...
                                        wire:confirm="Are you sure you want to delete this group? This action cannot be undone."
                                    >
                                        Delete
                                    </button>
                                </div>
